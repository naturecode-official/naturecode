...
# 4. 验证更新
naturecode --version  # 应该显示 1.4.7.3
```
...
**最后更新**: 2026-02-16  
**当前版本**: NatureCode v1.4.7.3 已部署到 GitHub
